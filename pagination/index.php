<?php
$con=mysqli_connect('localhost','root','','pratical11');
...
$record=mysqli_num_rows(mysqli_query($con,"select id,username from users"));
$pagi=ceil($record/$per_page);

$sql="select id,username from users limit $start,$per_page";
